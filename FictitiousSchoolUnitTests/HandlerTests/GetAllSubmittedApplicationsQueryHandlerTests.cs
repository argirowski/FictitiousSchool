...
namespace FictitiousSchoolUnitTests.HandlerTests
{
    public class GetAllSubmittedApplicationsQueryHandlerTests
    {
        ...
        public async Task Handle_ReturnsListOfFictitiousSchoolApplicationDTOs()
        {
            ...
            {
                new FictitiousSchoolApplication { Id = Guid.NewGuid(), CourseId = 1, Company = new Company { Id = Guid.NewGuid(), Name = "Company 1" } },
                new FictitiousSchoolApplication { Id = Guid.NewGuid(), CourseId = 2, Company = new Company { Id = Guid.NewGuid(), Name = "Company 2" } }
            };
            var applicationDTOs = new List<FictitiousSchoolApplicationDTO>
            {
                new FictitiousSchoolApplicationDTO { Id = applications[0].Id, Course = new CourseDTO { Id = 1, Name = "Course 1" }, Company = new CompanyDTO { Name = "Company 1" } },
                new FictitiousSchoolApplicationDTO { Id = applications[1].Id, Course = new CourseDTO { Id = 2, Name = "Course 2" }, Company = new CompanyDTO { Name = "Company 2" } }
            };
